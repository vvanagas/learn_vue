...
2. Read exactly ONE binding matching the language of the code at hand:
   ...
   `binding-vue.txt` splits from `binding-typescript.txt` by RUNTIME rather
   than language: browser-side Vue SFCs load it, server-side TypeScript keeps
